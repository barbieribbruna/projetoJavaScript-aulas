...
// notas é do tipo de array de números
// é semelhante a: const notas: number = 8, 9, 5
...
for(let nota of notas){ //nota representa cada item dentro da Colletion Notas
...
notas.push(4.0) // adiciona um ou mais elementos no final do array e retorna o novo comprimento do array
